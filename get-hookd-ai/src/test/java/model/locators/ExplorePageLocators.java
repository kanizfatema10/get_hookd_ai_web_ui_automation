...
public class ExplorePageLocators {
    public static By saveButtonOfTheFirstAd = By
            .xpath("//div[@class= 'ads-container']/div[2]/div[4]//button//span[contains(text(), 'Save')]");
    public static By selectBoardDropDownofTheFirstAd = By.xpath(
            "//div[@class= 'ads-container']/div[2]/div[4]//div/div/div[2]/div[contains(@class, 'p-multiselect-label')]");
